...
if __name__ == '__main__':
    ...
    sequences = ['MOT17-02', 'MOT17-04']  # Add your sequence names here

    # Define the directories for tracking results and ground truth data
    track_dir = './tracking_results'  # Replace with your tracking results directory
    gt_dir = './ground_truth'         # Replace with your ground truth data directory

    # Run evaluation
    evaluate_tracking(sequences, track_dir, gt_dir)
